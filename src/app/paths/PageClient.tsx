  ...
  return (
    <div className="space-y-6 animate-fade-in pb-8">
      <div className="text-right">
        <h1 className="text-xl font-bold text-foreground">مسارات التعلم</h1>
        ...
        {learningPaths.map((path) => {
          ...
          const progress =
            pathLessons.length > 0
              ...
              : 0;
          const isPathFullyCompleted =
            completedInPath === pathLessons.length && pathLessons.length > 0;
          ...
          return (
            ...
            >
              ...
              <div
                className={cn(
                  "p-5 text-right bg-gradient-to-br",
                  path.color || "from-secondary via-background to-secondary/30",
                )}
              >
                  ...
                  >
                    {isPathFullyCompleted ? (
                      ...
                      <>
                        ...
                        <span>
                          الاختبار مغلق (أكمل جميع الدروس لفتح الاختبار)
                        </span>
                      </>
                    )}
                  </button>
      ...
      {quizPathId && (
        <PathQuiz pathId={quizPathId} onClose={() => setQuizPathId(null)} />
      )}
