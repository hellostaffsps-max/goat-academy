...
export default function CoursesPageContent({
  ...
  const [activeTrack, setActiveTrack] = useState<LearningTrack>(initialTrack);
  ...
  const filteredLessons = useMemo(() => {
    return lessons.filter((lesson) => {
      ...
      const levelMatch =
        activeLevel === "all" || lesson.difficulty === levelLabels[activeLevel];
      const durationMatch =
        activeDuration === "all" ||
        getDurationCategory(lesson.read_time) === activeDuration;
      const typeMatch =
        activeType === "all" || getLessonType(lesson.category) === activeType;
