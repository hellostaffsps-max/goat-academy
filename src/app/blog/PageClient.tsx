...
export default function BlogPage() {
  ...
  // The server selects the public data source, including an intentionally empty result.
    ...
    <div className="animate-fade-in space-y-8">
      ...
      <section className="text-center py-8">
        ...
        <p className="body-base text-muted-foreground max-w-xl mx-auto">
          مقالات حصرية: قصص نجاح، نصائح أسبوعية، أخبار صناعة القهوة، ودراسات
          حالة
        </p>
      </section>
        ...
        {filteredArticles.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              لا توجد مقالات مطابقة للتصنيف المحدد
            </p>
          </div>
        ) : (
